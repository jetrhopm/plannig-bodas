    ...
    <head>
        ...
        <style>
            * {
            ...
            .scroll-fade{transition:opacity .55s ease,transform .55s cubic-bezier(.2,.75,.25,1)}.scroll-fade.is-away{opacity:.08;transform:translateY(28px) scale(.975)}.scroll-fade.is-visible{opacity:1;transform:none}@media(prefers-reduced-motion:reduce){.scroll-fade{transition:none}}
