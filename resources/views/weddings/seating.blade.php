...
<head>
    ...
    <style>
        :root{color:#3e302e;background:#fbf7f3;font-family:Arial,sans-serif}*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 92% 10%,#f7e7e3 0,transparent 30rem),#fbf7f3}.wrap{max-width:940px;margin:auto;padding:24px max(1rem,5vw) 48px}.back{display:inline-flex;align-items:center;gap:8px;color:#934e5b;font-weight:700;text-decoration:none}.back svg{width:18px;height:18px;fill:none;stroke:currentColor;stroke-width:2}.hero{display:flex;gap:20px;align-items:center;padding:28px 0 22px}.hero__icon,.section-icon,.table-icon{display:grid;place-items:center;flex:0 0 auto;border-radius:18px;color:#934e5b;background:#f5e4e1}.hero__icon{width:68px;height:68px}.hero__icon svg{width:38px;height:38px}.hero small{font-weight:700;letter-spacing:.16em;color:#a35e68}.hero h1{margin:7px 0;font:600 clamp(2rem,8vw,3.25rem)/1.03 Georgia,serif}.hero p{margin:0;color:#766864;line-height:1.5}.card{padding:20px;margin:12px 0;border:1px solid #ead8d0;border-radius:22px;background:#fffdfa;box-shadow:0 10px 25px #68443c0b}.card-head{display:flex;align-items:center;gap:11px}.section-icon{width:40px;height:40px}.section-icon svg{width:23px;height:23px}.card h2{margin:0;font:600 1.45rem Georgia,serif}.card form{display:grid;grid-template-columns:1fr 150px auto;gap:10px;margin-top:17px}input{width:100%;padding:12px;border:1px solid #ddcdc5;border-radius:12px;background:#fffdfb;color:#3e302e;font:14px Arial}input:focus{outline:2px solid #d49aa2;border-color:transparent}button{display:inline-flex;align-items:center;justify-content:center;gap:7px;border:0;border-radius:999px;padding:11px 16px;background:linear-gradient(135deg,#934d5d,#cf7880);color:#fff;font-weight:700;cursor:pointer}button svg{width:17px;height:17px;fill:none;stroke:currentColor;stroke-width:2}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:14px;margin-top:18px}.table{min-height:156px;padding:18px;border:1px solid #ead8d0;border-radius:20px;background:#fffdfa;box-shadow:0 8px 20px #68443c0b}.table-top{display:flex;align-items:center;justify-content:space-between;gap:12px}.table-icon{width:42px;height:42px}.table-icon svg{width:25px;height:25px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.table b{display:block;margin-top:14px;font:600 1.45rem Georgia,serif}.occupancy{margin:5px 0 10px;color:#8b7771}.members{color:#5f504d;font-size:12px;line-height:1.55}.empty{grid-column:1/-1;text-align:center;color:#766864}.line-icon{fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.areas-menu{border-bottom:1px solid #ead8d0;background:#fbf7f3}.areas-menu__hero{min-height:310px;padding:35px max(1rem,6vw);position:relative;overflow:hidden;background-position:center;background-size:cover}.areas-menu__hero p{margin:0;color:#765e5a;font-size:10px;font-weight:700;letter-spacing:.22em}.areas-menu__hero h1{margin:9px 0;font:600 clamp(2.6rem,12vw,4.25rem)/.95 Georgia,serif}.areas-menu__hero>div{max-width:330px;color:#77635e;font-size:16px;line-height:1.45}.areas-menu__hero aside{position:absolute;right:max(1rem,6vw);bottom:23px;padding:14px 17px;border-radius:17px;background:#fffdfbe8;box-shadow:0 12px 30px #663a321e}.areas-menu__hero aside b,.areas-menu__hero aside small{display:block}.areas-menu__hero aside b{margin-top:4px}.areas-menu__head{display:flex;align-items:baseline;justify-content:space-between;gap:12px;max-width:940px;margin:0 auto 14px;padding:18px max(1rem,5vw) 0}.areas-menu__head strong{font:600 clamp(1.45rem,6vw,2rem)/1.1 Georgia,serif}.areas-menu__head small{font-size:10px;font-weight:700;letter-spacing:.18em;color:#a35e68;white-space:nowrap}.areas-menu__grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;max-width:940px;margin:auto;padding:0 max(1rem,5vw) 20px}.areas-menu__item{min-height:132px;display:flex;flex-direction:column;justify-content:flex-end;padding:13px 10px;border:1px solid #eadbd3;border-radius:18px;background:#fffdfa;color:#4b3a38;text-decoration:none;box-shadow:0 8px 22px #5e38300e}.areas-menu__icon{width:31px;height:31px;display:grid;place-items:center;align-self:flex-start;margin-bottom:auto;color:#8d4c59}.areas-menu__icon svg{width:29px;height:29px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.areas-menu__item b{font:600 clamp(1rem,4.4vw,1.35rem)/1.04 Georgia,serif}.areas-menu__item small{margin-top:5px;color:#8b7771;font-size:10px}.areas-menu__item.is-active{border-color:#a75060;background:linear-gradient(135deg,#934d5d,#d47c83);color:#fff;box-shadow:0 12px 25px #91495444}.areas-menu__item.is-active .areas-menu__icon,.areas-menu__item.is-active small{color:#fff}@media(max-width:620px){.hero{align-items:flex-start}.hero__icon{width:55px;height:55px}.hero__icon svg{width:31px;height:31px}.card form{grid-template-columns:1fr}.card form button{width:100%}}@media(min-width:640px){.areas-menu__grid{grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.areas-menu__item{min-height:146px;padding:17px}}@media(min-width:1024px){.areas-menu__grid{grid-template-columns:repeat(6,minmax(0,1fr))}.areas-menu__item{min-height:130px}}
    </style>
</head>
<body>
    <x-wedding-areas-menu :navigation="$navigation" :base-path="$basePath" />
    <main class="wrap">
